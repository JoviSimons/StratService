...
const (
	StratService_ReturnAll_FullMethodName   = "/proto.StratService/returnAll"
	StratService_ReturnStrat_FullMethodName = "/proto.StratService/returnStrat"
	StratService_StoreStrat_FullMethodName  = "/proto.StratService/storeStrat"
)
...
func (c *stratServiceClient) ReturnAll(ctx context.Context, in *ReturnAllReq, opts ...grpc.CallOption) (StratService_ReturnAllClient, error) {
	stream, err := c.cc.NewStream(ctx, &StratService_ServiceDesc.Streams[0], StratService_ReturnAll_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *stratServiceClient) ReturnStrat(ctx context.Context, in *ReturnStratReq, opts ...grpc.CallOption) (*ReturnStratRes, error) {
	...
	err := c.cc.Invoke(ctx, StratService_ReturnStrat_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stratServiceClient) StoreStrat(ctx context.Context, in *StoreStratReq, opts ...grpc.CallOption) (*StoreStratRes, error) {
	...
	err := c.cc.Invoke(ctx, StratService_StoreStrat_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _StratService_ReturnStrat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StratService_ReturnStrat_FullMethodName,
	}
...
func _StratService_StoreStrat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StratService_StoreStrat_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
